...
async function wpFetch(url) {
  // Frischer 10s-Timeout pro Versuch: ein hängender Upstream darf das serielle Gate nicht
  // blockieren (sonst stauen sich alle folgenden Wikipedia-Requests dahinter für immer).
  const wp = () => fetch(url, { headers: { "user-agent": UA }, signal: AbortSignal.timeout(10000) });
