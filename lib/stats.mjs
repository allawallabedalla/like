...
let FILE = join(process.env.LIKE_DATA_DIR || dirname(dirname(fileURLToPath(import.meta.url))), "stats.json");
// pro Domain-Pack eine eigene Zeitreihen-Datei (Musik behält stats.json)
export function setStatsFile(path) { FILE = path; }
