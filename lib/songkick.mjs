// songkick.mjs — DEPRECATED (Runde 24 / U-2a.3).
// Die öffentliche Songkick-API (api.songkick.com/api/3.0) ist seit Jahren stillgelegt; ein neuer
// Key ist ohnehin nicht mehr erhältlich. Der Adapter ist daher NICHT mehr in lib/coappear.mjs
// eingebunden — er täuschte sonst eine zweite "zusammen aufgetreten"-Quelle vor, die es real nicht
// gibt. Datei bleibt als Referenz/Reaktivierungspunkt erhalten, falls Songkick je zurückkehrt.
//
// Frühere Nutzung: API-Key (https://www.songkick.com/api_key_requests/new) in like/.songkick-key
// oder ENV SONGKICK_KEY. Ohne Key war der Adapter immer inaktiv (return null).
