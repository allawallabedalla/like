...
async function api(path) {
  ...
  // Pause zweiarmig in der Gate-Kette: der NÄCHSTE Setlist.fm-Request wartet die 600 ms,
  // nicht der aktuelle Aufrufer (Taskforce R13; Drossel-Rate bleibt identisch).
  gate = job.then(() => sleep(600), () => sleep(600));
  return job;
}
...
export async function sharedBills(name, { maxEvents = 10 } = {}) {
