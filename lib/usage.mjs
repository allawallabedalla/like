...
// U-2c.5: letzten Stand beim Herunterfahren sichern (SIGTERM/SIGINT) — sonst gingen bis zu
// 15 s Zähler (das Flush-Intervall) beim Redeploy verloren.
export async function flushUsage() { return flush(); }
