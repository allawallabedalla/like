...
(function () {
  ...
  function assign() {
    ...
    // jeder Planet bekommt seinen eigenen Startwinkel -> individuell bremsbar
    rings.forEach(function (ring, r) { ring.els.forEach(function (el, i) { el._ang = (i / ring.els.length) * 6.2832 + r * 0.5; }); });
  }
  ...
  function frame(ts) {
    ...
    for (var r = 0; r < rings.length; r++) {
      var ring = rings[r], R = base * ring.f, spd = reduce ? 0 : 0.14 * ring.dir;
