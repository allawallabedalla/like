...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  <script>(function(){try{var f=localStorage.getItem("like_landing_flat")==="1";document.documentElement.setAttribute("data-theme",f?"light":"dark");}catch(e){document.documentElement.setAttribute("data-theme","dark");}})();</script>
...
(function () {
  ...
  function frame(ts) {
    ...
    if (flat) {
      ...
      // Pass 2: Kanten in die MITTE des grauen Knotens (Orb) ziehen — nicht auf die Element-Mitte,
      // die wegen Label/Unterzeile unter dem Orb liegt (sonst treffen die Striche schief). Ein
      // Layout-Read nach allen Writes = kein Thrash; die Linie verschwindet sauber unter dem Orb.
      ...
      for (var i2 = 0; i2 < planets.length; i2++) {
        ...
        nctx.beginPath(); nctx.moveTo(cx, cy); nctx.lineTo(r.left + r.width / 2, r.top + r.height / 2); nctx.stroke();
      }
    } else {
