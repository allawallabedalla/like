...
(function () {
  ...
  function assign() {
    ...
    // jeder Planet: eigener Startwinkel (grob verteilt + Zufalls-Jitter, damit sich nichts
    // ausrichtet) und eine PRO PLANET zufällig gewürfelte, sehr subtile Umlaufgeschwindigkeit
    // inkl. Richtung — natürliches, nicht gleichförmiges Kreisen (einmal gewürfelt, bleibt stabil).
